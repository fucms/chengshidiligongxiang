    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="角色名称">
          <el-input v-model="listQuery.filter1" placeholder="请输入角色名称" />
        </el-form-item>
        <el-form-item label="日志类型">
          <el-select v-model="listQuery.filter2" placeholder="请选择日志类型">
      ...
      >
        ...
        <el-table-column label="操作事项" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="日志类型" prop="type3" align="center">
          <template slot-scope="{ row }">
            <el-tag :type="row.type3 == 0 ? '' : 'success'">{{ row.type3 == 0 ? 'A' : 'B' }}</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" min-width="120">
          <template>
            ...
            <el-button size="mini">查看日志详情</el-button>
          </template>
        </el-table-column>
      </el-table>
