  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="共享协议扩展名称">
          <el-input v-model="listQuery.filter1" placeholder="请输入共享协议扩展名称" />
        </el-form-item>
        <el-form-item label="共享协议扩展类型">
          <el-input v-model="listQuery.filter2" placeholder="请输入共享协议扩展类型" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="共享协议扩展名称" prop="index" align="center" min-width="50">
          <template slot-scope="{ row }">
            <span>{{ row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="共享协议扩展类型" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" min-width="120">
          <template slot-scope="{ row }">
            ...
            <el-button size="mini" type="">下载文档</el-button>
            <el-button size="mini" type="">下载示例</el-button>
