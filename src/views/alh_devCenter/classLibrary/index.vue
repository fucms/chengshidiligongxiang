    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="类库名称">
          <el-input v-model="listQuery.filter1" placeholder="请输入类库名称" />
        </el-form-item>
        <el-form-item label="类库类型">
          <el-input v-model="listQuery.filter2" placeholder="请输入类库类型" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="类库名称" prop="index" align="center" min-width="50">
          <template slot-scope="{ row }">
            <span>{{ row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="类库类型" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
        <el-table-column label="简要说明" prop="type3" align="center">
          <template slot-scope="{ row }">
