  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="WEB服务接口名称">
          <el-input v-model="listQuery.filter1" placeholder="请输入WEB服务接口名称" />
        </el-form-item>
        <el-form-item label="接口类型">
          <el-input v-model="listQuery.filter2" placeholder="请输入接口类型" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="WEB服务接口名称" prop="index" align="center" min-width="50">
          <template slot-scope="{ row }">
            <span>{{ row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="接口类型" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
