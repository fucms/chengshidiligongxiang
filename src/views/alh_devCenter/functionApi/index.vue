  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="功能服务接口名称">
          <el-input v-model="listQuery.filter1" placeholder="请输入功能服务接口名称" />
        </el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="功能服务接口名称" prop="index" align="center" min-width="50">
