        ...
        <el-col :xs="24" :sm="24" :lg="12">
          <div class="chart-wrapper" style="position: relative">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="资源目录服务接口" name="collectedAmount" />
              <el-tab-pane label="数据服务接口" name="signAmount" />
              <el-tab-pane label="功能服务接口" name="clientNum" />
              <el-tab-pane label="WEB服务接口" name="invoiceAmount" />
            </el-tabs>
            <div class="chartBox">
              <p>
                <span>完成值：</span>
